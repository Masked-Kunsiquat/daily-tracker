        ...
        <TouchableOpacity style={styles.container} accessibilityRole="button">
          <View style={styles.header}>
            <Text style={styles.date}>
              {formatEntryDate(entry.date, todayISO)}
            </Text>
          ...
          <View style={styles.stats}>
            <Text style={styles.statText}>
              ...
              {entry.things_learned.length} • 🙏 {entry.things_grateful.length}
            </Text>
          </View>
        </TouchableOpacity>
      </Link>
...
const RatingDots: React.FC<{ ratings: DailyEntry["ratings"] }> = ({
  ratings,
}) => (
  <View style={styles.ratingDots} accessible accessibilityLabel="Ratings">
    <View
      style={[
        styles.dot,
        { backgroundColor: getRatingColor(ratings.productivity) },
      ]}
    />
    <View
      style={[
        styles.dot,
        styles.dotSpacing,
        { backgroundColor: getRatingColor(ratings.mood) },
      ]}
    />
    <View
      style={[
        styles.dot,
        styles.dotSpacing,
        { backgroundColor: getRatingColor(ratings.energy) },
      ]}
    />
  </View>
);
